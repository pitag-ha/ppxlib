...
val interface: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Parsetree.signature_item list)

val implementation: (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Parsetree.structure_item list)
